...
function Websites(props) {
    ...
    const handleChange = (event) => {
      ...
      const handleOpen= (e)=> {
          setData(prev=>{return prev.map((item)=>{
              if(item.title === e)
