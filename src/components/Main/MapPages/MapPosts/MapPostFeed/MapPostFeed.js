        ...
        <div className="mapPostFeed">
            ...
            <ListItemMapPost rad index={0} sum="10549834" instagram="49535" twitter="578345" rss="15865" telegram="854653" title="تهران">
                <div className="postListDivKP">
                        <div className="indexOfpostsMapBox"><span> عکس </span><span style={{marginRight:'150px'}}> عنوان و توضیحات  { /*item.title? "عنوان و توضیح": "عنوان"*/}</span><span style={{marginRight:'213px'}}>اطلاعات فرستنده</span><span style={{marginRight:'120px'}}> کلمات کلیدی دیگر متن </span></div>
                                        <MapPostPostList title="ترافیک تهران" top={['خراسان جنوبی ','خوزستان' , 'ایران', 'بیرجند']}
                                        ...
                                        username="Alireza.m"
                                        social={2}/>
                                        <MapPostPostList title="حادثه در تهران" top={['تبریز ','بوشهر' , 'زنجان', 'طبس']}
                                        image="https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885__480.jpg" 
                                        summary=" به گزارش خبرآنلاین، معاون وزیر راه و شهرسازی با اعلام این خبر در گفت‌و گو با  یک برنامه رادیویی اعلام کرد: به دنبال افزایش تقاضای تمدید مهلت ثبت‌نام در سامانه نهضت ملی مسکن، نام‌نویسی در این طرح که تا پیش از این ۲۸ آبان به اتمام می‌رسید، تا ۱۵ آذر ماه تمدید شده است. متقاضیان می‌توانند بدون نگرانی ثبت‌نام در مرحله اول نهضت ملی مسکن را در سامانه مربوطه به آدرس saman.mrud.ir انجام دهند.
                                        ...
                                        username="ISNA"
                                        social={3}/>
                                        <MapPostPostList  top={['گرگان ','تهران' , 'مشهد', 'ماشهر']}
                                        image="https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885__480.jpg" 
                                        summary=" به گزارش خبرآنلاین، معاون وزیر راه و شهرسازی با اعلام این خبر در گفت‌و گو با  یک برنامه رادیویی اعلام کرد: به دنبال افزایش تقاضای تمدید مهلت ثبت‌نام در سامانه نهضت ملی مسکن، نام‌نویسی در این طرح که تا پیش از این ۲۸ آبان به اتمام می‌رسید، تا ۱۵ آذر ماه تمدید شده است. متقاضیان می‌توانند بدون نگرانی ثبت‌نام در مرحله اول نهضت ملی مسکن را در سامانه مربوطه به آدرس saman.mrud.ir انجام دهند.
                                        ...
                                        username="amirali"
                                        social={4}/>
                                        <MapPostPostList top={['قشم ','شیراز' , 'اصفهان', 'بندرعباس']}
                                        image="https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885__480.jpg" 
                                        summary=" به گزارش خبرآنلاین، معاون وزیر راه و شهرسازی با اعلام این خبر در گفت‌و گو با  یک برنامه رادیویی اعلام کرد: به دنبال افزایش تقاضای تمدید مهلت ثبت‌نام در سامانه نهضت ملی مسکن، نام‌نویسی در این طرح که تا پیش از این ۲۸ آبان به اتمام می‌رسید، تا ۱۵ آذر ماه تمدید شده است. متقاضیان می‌توانند بدون نگرانی ثبت‌نام در مرحله اول نهضت ملی مسکن را در سامانه مربوطه به آدرس saman.mrud.ir انجام دهند.
